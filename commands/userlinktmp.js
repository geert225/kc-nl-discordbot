...
module.exports = {
    ...
    execute(message, args) {
      ...
      if (!message.member.hasPermission("MANAGE_MESSAGES")) {
        message.channel.send(`:x:You don't have rights to this command! If you are a member try using the command: ${prefix}linktmp.`).then(msg => {msg.delete({ timeout: 10000 })});return;}
